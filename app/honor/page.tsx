          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                ...
                <p className="leading-relaxed text-base">2024年3月取得</p>
                <a
                  href="https://www.credly.com/badges/05edcaa5-7fa7-4d45-9f09-fa827beec5c1"
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                ...
                <p className="leading-relaxed text-base">2024年2月取得</p>
                <a
                  href="https://bcert.me/skuxdamxs"
                  className="mt-3 text-indigo-400 inline-flex items-center"
                >
                  Learn More
                  <svg
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                ...
                <p className="leading-relaxed text-base">2022年1月取得</p>
                <a
                  href="https://www.credly.com/badges/b6281cda-7e7f-46b6-8fe2-415966db2831"
                  className="mt-3 text-indigo-400 inline-flex items-center"
                >
                  Learn More
                  <svg
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                ...
                <p className="leading-relaxed text-base">2021年3月取得</p>
                <a
                  href="https://www.credly.com/badges/82781d1f-9185-4fde-9779-6496876908c5"
                  className="mt-3 text-indigo-400 inline-flex items-center"
                >
                  Learn More
                  <svg
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                ...
                <p className="leading-relaxed text-base">2021年1月取得</p>
                <a
                  href="https://www.credly.com/badges/33da4733-6f66-431d-b2b4-946557967ce7"
                  className="mt-3 text-indigo-400 inline-flex items-center"
                >
                  Learn More
                  <svg
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                ...
                <p className="leading-relaxed text-base">2020年8月取得</p>
                <a
                  href="https://www.credly.com/badges/05edcaa5-7fa7-4d45-9f09-fa827beec5c1"
                  className="mt-3 text-indigo-400 inline-flex items-center"
                >
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                <h2 className="text-lg font-medium mb-3">基本情報技術者</h2>
