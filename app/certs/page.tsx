        ...
        <div className="container px-5 py-5 mx-auto">
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            ...
            <Element
              ...
              thumbnail={
                <div className="w-36 h-36 inline-flex items-center justify-center rounded-full bg-solarized-dark dark:bg-solarized-light text-solarized-dark dark:text-solarized-light mb-5">
                  <svg
